...
static char selbordercolor[]        = "#D75F00";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,	        XK_r,      	spawn,     	{.v = (const char*[]){ TERMINAL, "-e", "abduco", "-A", "dvtm-session", "dvtm-status", "-M", "lfub", "lfub", NULL } } },
	{ MODKEY|ControlMask,		XK_r,		spawn,		SHCMD("pkill -USR1 redshift") },
	/* { MODKEY|ShiftMask,		XK_r,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "htop", NULL } } }, */
	{ MODKEY,			XK_t,		focusmon,	{.i = -1 } },
	{ MODKEY|Mod1Mask,		XK_t,		tagmon,		{.i = +1 } },
	...
	{ MODKEY,			XK_a,		spawn,          {.v = (const char*[]){ "dmenu_run", NULL } } },
	{ MODKEY|ShiftMask,		XK_a,		spawn,		{.v = (const char*[]){ "passmenu", NULL } } },
